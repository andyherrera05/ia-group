    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div class="text-center mb-12">
            <h2 class="text-4xl sm:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-amber-400 to-yellow-500 mb-4">
                CALCULADORA DE <span class="text-yellow-500">IMPUESTOS</span>
            </h2>
            <p class="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed">Calcula aranceles, IVA y costos aduaneros</p>
                ...
                <div class="bg-white/5 backdrop-blur-xl border-2 border-white/10 rounded-2xl p-6 shadow-2xl transition-all duration-300 hover:border-yellow-500/30 sticky top-24">
                            ...
                            <div class="space-y-3">
                                ...
                                @foreach ($desglose as $concepto => $valor)
                                    <div class="flex justify-between items-center py-3 border-b border-white/5 hover:bg-white/5 px-3 rounded-lg transition-all">
                                        <span class="text-gray-300 text-sm font-medium {{ str_contains($concepto, 'Total') ? 'font-bold' : '' }}">{{ $concepto }}</span>
                                        <span class="font-bold text-sm {{ str_contains($concepto, 'Total') ? 'text-yellow-500' : 'text-white' }}">
                                            @if (is_numeric($valor))
                                                {{ $valor }}
                                            @else
                                                ${{ $valor }}
                    ...
                    @else
                        <div class="text-center py-16">
                            ...
                            <p class="text-gray-500 text-sm font-medium">Completa el formulario para generar tu cálculo</p>
                        </div>
                    @endif
                        ...
                        <div class="mt-8 bg-gradient-to-br from-yellow-500/10 to-amber-500/10 border-2 border-yellow-500 rounded-xl p-5 animate-pulse" style="animation-duration: 2s;">
                            ...
                            @else
                                ...
                                <div class="text-center space-y-4">
                                    ...
                                    <a href="https://wa.me/5491123456789?text=Hola !%20Vi%20el%20cálculo%20de%20impuestos%20de%20${{ $resultado }}%20y%20me%20gustaría%20más%20información." 
                                       target="_blank"
            ...
            <div class="flex items-start space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-300 text-sm leading-relaxed">
                        Las tasas de impuestos varían según el país y tipo de producto. Esta calculadora usa tasas estimadas para Argentina.
                        <strong class="text-yellow-500">Consulta con un agente aduanal</strong> para valores exactos y asesoría personalizada.
                    </p>
                </div>
            </div>
        </div>
