<div class="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-900 text-white overflow-x-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed">Calcula el costo de tus envíos aéreos express</p>
            ...
            <div class="flex items-start space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-300 text-sm leading-relaxed">
                        Los cálculos son estimaciones basados en tarifas estándar. El precio final puede variar según disponibilidad, aerolínea y condiciones especiales del servicio.
