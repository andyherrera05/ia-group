            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white/5 backdrop-blur-xl border border-yellow-500/20 rounded-2xl p-2 shadow-xl">
                    <div class="grid grid-cols-3 gap-2">
                        ...
                        'uld' => ['title' => 'Roll-on/Roll-off', 'subtitle' => 'Vehiculos'],
                        ] as $key => $tab)
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between items-center py-2 px-4 bg-white/5 rounded-lg border border-white/5">
                                <div class="flex items-center gap-2">
                                    ...
                                    @if(in_array(trim($concepto), ['Agencia Despachante', 'Cargos de importacion y despacho', 'Impuestos', 'GA', 'Poliza de Importacion', 'ICE', 'IVA', 'Transporte Terrestre', 'Representación Importación']))
