    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <!-- Card: Tipo de Carga -->
                <div
                    class="bg-white/5 backdrop-blur-xl border border-yellow-500/20 rounded-2xl p-6 shadow-xl transition-all duration-300 hover:border-yellow-500/50 hover:shadow-yellow-500/10">
                    <label class="block text-yellow-500 font-bold mb-4 text-sm uppercase tracking-widest">Tipo de
                        Carga</label>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <button wire:click="$set('tipoCarga', 'lcl')"
                            ...
                            <span
                                class="absolute inset-0 bg-gradient-to-r from-yellow-500 to-amber-500 opacity-0 group-hover:opacity-10 transition-opacity"></span>
                        ...
                        <button wire:click="$set('tipoCarga', 'air')"
                            class="group relative overflow-hidden px-5 py-5 border-2 rounded-xl font-bold transition-all 
                                   {{ $tipoCarga === 'air'
                                       ? 'border-yellow-500 bg-gradient-to-br from-yellow-500/20 to-amber-500/20 text-yellow-400 shadow-lg shadow-yellow-500/20'
                                       : 'border-white/10 text-gray-300 hover:border-yellow-500/50 hover:text-yellow-400' }}">
                            <span
                                class="absolute inset-0 bg-gradient-to-r from-yellow-500 to-amber-500 opacity-0 group-hover:opacity-10 transition-opacity"></span>
                            <span class="relative block text-center">
                                <span class="text-lg">AÉREO</span>
                                <span class="block text-xs font-normal mt-1 text-gray-400">Transporte Aéreo</span>
                            </span>
                        </button>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-2">
                            <label class="block text-yellow-500 font-bold text-xs uppercase tracking-widest">Puerto
                                Origen</label>
                ...
                <!-- Card: Precio, Peso y Cantidad -->
                <div
                    class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl transition-all duration-300 hover:border-yellow-500/30">

                    <!-- Título opcional del bloque -->
                    <h3 class="text-yellow-500 font-bold mb-5 text-sm uppercase tracking-widest">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                        <!-- Precio (USD) -->
                        <div class="space-y-2">
                            <label class="block text-yellow-500 font-bold text-xs uppercase tracking-widest">
                                Precio (USD)
                            </label>
                            <input type="number" wire:model="valorMercancia" step="1" placeholder="5000"
                                class="w-full bg-black/30 border-2 border-white/10 text-white px-4 py-3.5 rounded-xl focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20 transition-all placeholder-gray-600">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" wire:model="cantidad" step="1" placeholder="1"
                ...
                <div
                    ...
                    <div class="grid grid-cols-3 gap-3 sm:gap-4">
                        <div class="space-y-2">
                            ...
                            <input type="number" wire:model="largo" placeholder="100"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" wire:model="alto" placeholder="60"
                                class="w-full bg-black/30 border-2 border-white/10 text-white px-3 py-3 rounded-lg focus:outline-none focus:border-yellow-500 transition-all text-sm placeholder-gray-600">
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:sticky lg:top-32">
                <div
                    class="bg-white/5 backdrop-blur-xl border-2 border-white/10 rounded-2xl p-6 shadow-2xl transition-all duration-300 hover:border-yellow-500/30">
                    ...
                    @if ($resultado !== null)
                        ...
                        <div
                            ...
                            <p class="text-xs font-bold text-yellow-400 mb-2 uppercase tracking-widest">Total Estimado
                            </p>
                            <p class="text-5xl font-black text-yellow-400">${{ $resultado }}</p>
                            <p class="text-xs text-gray-400 mt-2">USD - Dólares</p>
                        </div>
                        ...
                        <div class="mt-8 bg-gradient-to-br from-yellow-500/10 to-amber-500/10 border-2 border-yellow-500 rounded-xl p-5 animate-pulse"
                            ...
                            @if ($respuestaUsuario === null)
                                <div class="text-center">
                                    <h3 class="text-xl font-black text-yellow-500 mb-5">
                                        ¿Te gusta el precio?
                                    </h3>
                            ...
                            @else
                                <div class="text-center space-y-4">
                                    ...
                                    <a href="https://wa.me/59164700293?text=Hola%20IA%20GROUPS!%20Necesito%20información%20sobre%20envío%20marítimo.%20Cotización:%20${{ $resultado }}"
                                        target="_blank"
