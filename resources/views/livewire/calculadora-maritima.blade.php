<div class="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-900 text-white overflow-x-hidden">
    ...
    <header class="bg-white/5 backdrop-blur-xl border-b border-yellow-500/20 sticky top-0 z-50 shadow-2xl">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
            <div class="flex items-center justify-between">
                ...
                <a href="/" class="text-yellow-400 hover:text-yellow-300 font-medium transition-all flex items-center space-x-2 group">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div class="text-center mb-12">
            <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-amber-400 to-yellow-500 mb-3">
                ...
                <div class="bg-white/5 backdrop-blur-xl border-2 border-white/10 rounded-2xl p-6 shadow-2xl transition-all duration-300 hover:border-yellow-500/30">
                    ...
                    @if ($resultado !== null)
                        ...
                        <div class="bg-gradient-to-br from-yellow-500/10 to-amber-500/10 border-2 border-yellow-500 rounded-xl p-6 mb-6 text-center transition-all hover:shadow-yellow-500/20 hover:shadow-xl">
                            <p class="text-xs font-bold text-yellow-400 mb-2 uppercase tracking-widest">Total Estimado</p>
                        ...
                        @if (count($desglose) > 0)
                            <div class="space-y-3">
                                <h3 class="font-bold text-yellow-500 uppercase text-xs tracking-widest mb-4 border-b border-yellow-500/20 pb-3">Desglose de Costos</h3>
                        ...
                        <div class="mt-8 bg-gradient-to-br from-yellow-500/10 to-amber-500/10 border-2 border-yellow-500 rounded-xl p-5 animate-pulse" style="animation-duration: 2s;">
                            ...
                            @else
                                <div class="text-center space-y-4">
                                    ...
                                    <a href="https://wa.me/59164700457?text=Hola%20IA%20GROUPS!%20Necesito%20información%20sobre%20envío%20marítimo.%20Cotización:%20${{ $resultado }}" 
                                        target="_blank"
            ...
            <div class="flex items-start space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-300 text-sm leading-relaxed">
                        Estos cálculos son estimaciones basadas en tarifas estándar. El precio final puede variar según disponibilidad, tipo de contenedor y condiciones especiales del servicio.
