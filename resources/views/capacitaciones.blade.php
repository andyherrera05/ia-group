...
<head>
    ...
    <title>Capacitaciones - IA GROUPS</title>
...
<body class="bg-black min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-2xl mx-auto px-4 text-center">
        ...
        <h2 class="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
            <span class="bg-gradient-to-r from-teal-400 via-cyan-400 to-teal-500 bg-clip-text text-transparent">Capacitaciones</span>
        </h2>
        ...
        <div class="bg-gradient-to-br from-yellow-500/10 to-amber-500/5 border border-yellow-500/30 rounded-xl p-8 mb-8">
            ...
            <p class="text-gray-300 text-lg leading-relaxed">
                Próximamente tendremos disponible nuestro programa de capacitaciones personalizadas 
                para emprendedores que buscan escalar sus negocios a nivel internacional.
            </p>
        </div>
        ...
        <div class="mt-12">
            ...
            <div class="w-full bg-gray-800 rounded-full h-2">
                <div class="bg-gradient-to-r from-teal-500 to-cyan-500 h-2 rounded-full animate-pulse" style="width: 45%"></div>
            </div>
        </div>
    </div>
</body>
