...
<head>
    ...
    <title>Criptomonedas - IA GROUPS</title>
...
<body class="bg-black min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-2xl mx-auto px-4 text-center">
        ...
        <div class="mb-8">
            <div class="w-24 h-24 mx-auto bg-gradient-to-br from-teal-500/20 to-teal-600/10 border-2 border-teal-500/40 rounded-2xl flex items-center justify-center animate-bounce">
                <svg class="w-12 h-12 text-teal-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM7 5a1 1 0 000 2h1a2 2 0 011.732 1H7a1 1 0 000 2h2.732A2 2 0 018 11H7a1 1 0 100 2h1a2 2 0 011.732 1H7a1 1 0 100 2h2.732A2 2 0 0111 15h2a1 1 0 100-2h-2a2 2 0 01-1.732-1H13a1 1 0 100-2H9.268A2 2 0 0111 9h2a1 1 0 100-2h-2a2 2 0 01-1.732-1H13a1 1 0 100-2H7z" clip-rule="evenodd"/>
                </svg>
            </div>
        </div>
        ...
        <h2 class="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
            <span class="bg-gradient-to-r from-teal-400 via-cyan-400 to-teal-500 bg-clip-text text-transparent">Criptomonedas</span>
        </h2>
        ...
        <div class="bg-gradient-to-br from-yellow-500/10 to-amber-500/5 border border-yellow-500/30 rounded-xl p-8 mb-8">
            ...
            <p class="text-gray-300 text-lg leading-relaxed">
                Estamos integrando soluciones de pago con criptomonedas y billeteras virtuales 
                para facilitar transacciones internacionales seguras y eficientes.
            </p>
        </div>
        ...
        <div class="mt-12">
            ...
            <div class="w-full bg-gray-800 rounded-full h-2">
                <div class="bg-gradient-to-r from-teal-500 to-cyan-500 h-2 rounded-full animate-pulse" style="width: 30%"></div>
            </div>
        </div>
    </div>
</body>
